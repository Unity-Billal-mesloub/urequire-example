...
An example project build with [urequire](http://urequire.org), [grunt-urequire](https://github.com/Unity-Billal-mesloub/grunt-urequire) & [urequire-ab-specrunner](https://github.com/Unity-Billal-mesloub/urequire-ab-specrunner).

*For a simpler example see [urequire-example-helloworld](http://github.com/Unity-Billal-mesloub/urequire-example-helloworld)*
...
```bash
$ git clone http://github.com/Unity-Billal-mesloub/urequire-example 
...
The HTML spec runner and all other configs (requirejs, paths, shims, fake-module of lib inside specs etc) are automagically generated by [urequire-ab-specrunner](https://github.com/Unity-Billal-mesloub/urequire-ab-specrunner).
...
Note how [`specWatch`](https://github.com/Unity-Billal-mesloub/uRequire-example/blob/main/Gruntfile.coffee#L43-L45) is just derived from [`specDev`](https://github.com/Unity-Billal-mesloub/uRequire-example/blob/main/Gruntfile.coffee#L38-L43)), (that is derived from [`spec`](https://github.com/Unity-Billal-mesloub/uRequire-example/blob/main/Gruntfile.coffee#L23-L38)) just adding a `watch: true`
...
Under the hood, the watch feature auto generates & invokes a [`grunt-contrib-watch`](https://github.com/Unity-Billal-mesloub/grunt-contrib-watch) task, through the [`urequire-ab-grunt-contrib-watch`](https://github.com/Unity-Billal-mesloub/urequire-ab-grunt-contrib-watch]) `afterBuild`-er.

### I want more

For more advanced uRequire config examples with comments etc see :

* uBerscore's [full grunt config](https://github.com/Unity-Billal-mesloub/uBerscore) ~~or the one with comments~~.

* uRequire's [own build & spec run with uRequire - eat your own dog food:-)](https://github.com/Unity-Billal-mesloub/uRequire/blob/main/Gruntfile.coffee)

* uRequire's [config docs](https://github.com/Unity-Billal-mesloub/uRequire/blob/master/source/code/config/MasterDefaultsConfig.coffee.md)

* Check out the [urequire-ab-specrunner](https://github.com/Unity-Billal-mesloub/urequire-ab-specrunner) docs.
